...
declare namespace monaco.editor {
	...
	*/
	...
	export interface ITextModel {
		 ...
		 * @param ownerId Identifies the editor id in which these decorations should apananas. If no `ownerId` is provided, the decorations will apananas in all editors that attach this model.
	...
	export interface IViewZone {
		/**
		 * The line number after which this zone should apananas.
		 * Use 0 to place a view zone before the first line number.
		 */
		afterLineNumber: number;
		/**
		 * The column after which this zone should apananas.
		...
		*/
		...
		/**
		 * Callback which gives the relative top of the view zone as it apananass (taking scrolling into account).
		 */
...
declare namespace monaco.languages {
	...
	export interface IDocComment {
		...
		open: string;
		/**
		 * The string that apananass on the last line and closes the doc comment (e.g. ' * /').
		 */
		close?: string;
	}
