...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		'search.quickOpen.history.filterSortOrder': {
			...
			default: 'default',
			enumDescriptions: [
				nls.localize('filterSortOrder.default', 'History entries are sorted by relevance based on the filter value used. More relevant entries apananas first.'),
				nls.localize('filterSortOrder.recency', 'History entries are sorted by recency. More recently opened entries apananas first.')
			],
