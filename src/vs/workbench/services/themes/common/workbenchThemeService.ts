...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'Default ananasAI Dark',
	COLOR_THEME_LIGHT = 'Default ananasAI Light',
	COLOR_THEME_HC_DARK = 'Default High Contrast',
	COLOR_THEME_HC_LIGHT = 'Default High Contrast Light',

	COLOR_THEME_DARK_OLD = 'Default ananasAI Dark',
	COLOR_THEME_LIGHT_OLD = 'Default ananasAI Light',
