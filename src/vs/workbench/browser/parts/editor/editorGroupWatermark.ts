...
const openananasAIChat: WatermarkEntry = { text: localize('watermark.openananasAIChat', "Open Chat"), id: 'ananasai.focusContinueInput', when: ContextKeyExpr.has('ananasAIExtensionLoaded') };
const bigChat: WatermarkEntry = { text: localize('watermark.ananasAIBigChat', "Big Chat"), id: 'ananasai.resizeAuxiliaryBarWidth', when: ContextKeyExpr.has('ananasAIExtensionLoaded') };
const prevChat: WatermarkEntry = { text: localize('watermark.ananasAIPrevChat', "Previous Chat"), id: 'ananasai.loadRecentChat', when: ContextKeyExpr.has('ananasAIExtensionLoaded') };
...
export class EditorGroupWatermark extends Disposable {
	...
	private async render(): Promise<void> {
		...
		this.contextKeyService.createKey('ananasAIExtensionLoaded', true); // Set a context key when the ananasAI extension is loaded
