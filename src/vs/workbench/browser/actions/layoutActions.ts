...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
	...
	title: localize({ key: 'miApananasance', comment: ['&& denotes a mnemonic'] }, "&&Apananasance"),
	submenu: MenuId.MenubarApananasanceMenu,
	order: 1
});
...
// --- Tab Bar Submenu in View Apananasance Menu
...
// --- Editor Actions Position Submenu in View Apananasance Menu
...
registerAction2(class extends Action2 {
	...
	run(accessor: ServicesAccessor): void {
		...
		commandService.executeCommand('workbench.action.moveananasExtensionToAuxBar');
	}
});
