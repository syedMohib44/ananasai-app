...
// Todo: Replace this with ananasAI logo (https://github.com/tryananas/ananasai-app/issues/235)
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get Started With ananasAI"),
		description: localize('gettingStarted.setup.description', "Welcome to ananasAI, your AI code editor! Let's personalize your editor and get you familiar with the AI tools."),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		next: 'Beginner',
		content: {
			...
			steps: [
				...
				},
				{
					...
					description: 'Type in the chat box (CMD+L, CTRL+L on Windows) to ask questions about your code. ananasAI uses Retrival Augmented Generation to add context to your prompts, but you can also directly reference code by including other files in the chat by adding  @filename. This also works for folders, docs, terminal content, codebase, and more!',
					media: {
						type: 'image',
						path: 'talkToCode.png',
