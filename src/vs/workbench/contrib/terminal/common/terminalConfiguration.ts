...
let terminalDescription = localize('terminalDescription', "Controls the terminal description, which apananass to the right of the title. Variables are substituted based on the context:");
...
const terminalConfiguration: IConfigurationNode = {
	...
	properties: {
		...
		[TerminalSettingId.DefaultLocation]: {
			...
			default: 'view',
			description: localize('terminal.integrated.defaultLocation', "Controls where newly created terminals will apananas.")
		},
