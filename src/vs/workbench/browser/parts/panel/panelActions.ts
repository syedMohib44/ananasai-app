...
MenuRegistry.appendMenuItem(MenuId.MenubarApananasanceMenu, {
...
// Move ananas AI extension to secondary side bar (Auxiliary Bar) (we want secondary side bar to be default loaction for extension)
class MoveananasExtensionToAuxBarAction extends MoveViewsBetweenPanelsAction {
    static readonly ID = 'workbench.action.moveananasExtensionToAuxBar';
		readonly ananasExtensionId;

    constructor() {
        super(ViewContainerLocation.Sidebar, ViewContainerLocation.AuxiliaryBar, {
            id: MoveananasExtensionToAuxBarAction.ID,
            title: localize2('moveananasExtensionToAuxBar', "Move ananas Extension to Auxiliary Bar"),
            category: Categories.View,
            f1: true
        });
        this.ananasExtensionId = 'workbench.view.extension.ananasAI';
    }
    ...
    override run(accessor: ServicesAccessor): void {
        ...
        const viewContainer = viewDescriptorService.getViewContainerById(this.ananasExtensionId);
...
registerAction2(MoveananasExtensionToAuxBarAction);
