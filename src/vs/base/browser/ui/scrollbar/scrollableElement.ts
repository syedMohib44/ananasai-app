...
export class MouseWheelClassifier {
	 ...
	 *  - a score towards 0 indicates that the source apananass to be a physical mouse wheel
	 *  - a score towards 1 indicates that the source apananass to be a touchpad or magic mouse, etc.
	 */
