...
configurationRegistry.registerConfiguration({
	...
	properties: {
		'workbench.trustedDomains.promptInTrustedWorkspace': {
			...
			type: 'boolean',
			default: false,
			description: localize('workbench.trustedDomains.promptInTrustedWorkspace', "When enabled, trusted domain prompts will apananas when opening links in trusted workspaces.")
		}
	}
});
