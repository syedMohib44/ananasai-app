...
export const enum FlowControlConstants {
	 ...
	 * apananas to stutter. In reality this balance is hard to accomplish though so heavy commands
...
export interface ITerminalProfile {
	...
	/**
	 * An additional unsafe path that must exist, for example a script that apananass in {@link args}.
	 */
